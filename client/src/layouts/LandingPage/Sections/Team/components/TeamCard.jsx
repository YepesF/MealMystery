...
const TeamCard = ({ urls, role, name, photo, skills, index }) => {
  ...
  return (
    <article
      ...
      className={`flex h-full flex-col items-start justify-between border-t p-1 md:w-1/3 md:p-4 ${index === 0 && "border-r"} cursor-pointer border-gray-400 dark:border-primary`}
    >
      <div className="relative h-full w-full">
        ...
        <div className="mb-10 h-[15vh] flex-shrink-0 md:h-[50vh]">
          <img
            className="h-full w-full object-cover md:h-[50vh]"
            src={photo}
            style={{
