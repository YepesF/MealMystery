        ...
        <div className="h-full flex justify-between flex-col py-16">
          <div className="px-96">
            <Typography className="font-extrabold w-full" variant="h2">
              ...
              <Typography
                className="text-primary text-10xl text-start"
                variant="body1"
              >
                Recipe®
              </Typography>
              <Typography
                className="text-primary text-10xl text-end"
                variant="body1"
              >
                Experience
              </Typography>
          ...
          <div className="w-full flex justify-between">
            <div className="w-full">
              <Typography className="w-1/4 text-primary" variant="body2">
                ...
                {list.map((el, index) => (
                  <li key={index}>
                    <div className="border-t flex">
                      <Typography
                        className="w-1/4 text-primary border-primary border-r font-extrabold text-2xl"
                        variant="body1"
                      >
                        {index + 1}
                      </Typography>
                      <Typography
                        className="text-primary border-primary ml-24 font-extrabold text-2xl"
                        variant="body1"
                      >
                        {el}
                      </Typography>
